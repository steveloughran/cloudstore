...
public class TestAuditLogProcessor {
     ...
     */
    static final String SAMPLE_LOG_ENTRY_1 = "183c9826b45486e485693808f38e2c4071004bf5dfd4c3ab210f0a21a4000000"
            + " bucket-london"
    ...
    static final String SAMPLE_LOG_ENTRY_2 = "01234567890123456789"
            + " bucket-london1"
            + " [" + TIMESTAMP_2 + "]"
            + " 109.157.171.174"
            + " arn:aws:iam::152813717700:user/dev"
    ...
    public void testMergeAndParseAuditLogFiles() throws IOException {
        ...
        String auditLogDir =
                this.getClass().getClassLoader().getResource("TestAuditLogs").toString();
        String auditSingleFile = this.getClass()
                .getClassLoader()
                .getResource("TestAuditLogs/sampleLog1")
                .toString();
        Preconditions.checkArgument(
                !StringUtils.isAnyBlank(auditLogDir, auditSingleFile),
                String.format(
        ...
        long mergeAndParseResult = auditLogProcessor.mergeAndParseAuditLogFiles(
                auditDirPath, destPath, true, org.apache.hadoop.fs.store.audit.AuditLogProcessor.PROCESS_ALL);
    ...
    public void testMergeAndParseAuditLogCounter() throws IOException {
        ...
        auditLogProcessor.mergeAndParseAuditLogFiles(
                logsPath, destPath, true, org.apache.hadoop.fs.store.audit.AuditLogProcessor.PROCESS_ALL);
        assertThat(auditLogProcessor.getLogRecordsProcessed())
    ...
    public void invalidStringThrowsDateTimeParseException() {
        Assertions.assertThatThrownBy(() -> parseToInstant("not a date")).isInstanceOf(DateTimeParseException.class);
    }
}
