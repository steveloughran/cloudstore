...
public final class StoreTestUtils extends Assert {
    ...
    public static <E extends Throwable> E expectException(Class<E> clazz, final Tool tool, final String... args)
            throws Exception {
        return intercept(clazz, new Callable<Integer>() {
            @Override
    ...
    public static <T> ExitUtil.ExitException expectExitException(int exitCode, Callable<T> eval) throws Exception {
