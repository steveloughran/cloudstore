...
hadoop jar cloudstore-1.3.jar committerinfo abfs://testing@ukwest.dfs.core.windows.net/
...
```
> hadoop jar cloudstore-1.3.jar committerinfo s3a://landsat-pds/
...
```
>  hadoop jar  cloudstore-1.3.jar committerinfo s3a://example-ireland-ireland-new/
