...
```
> bin/hadoop jar cloudstore-1.3.jar etag s3a://example-london/file
...
```
> bin/hadoop jar cloudstore-1.3.jar etag s3a://alice--usw2-az1--x-s3/file
...
```
> bin/hadoop jar cloudstore-1.3.jar etag s3a://ecsstore/file
...
> bin/hadoop jar cloudstore-1.3.jar etag s3a://example-london/dir/subdir
...
```
> bin/hadoop jar cloudstore-1.3.jar etag abfs://alice-testing@alicewales.dfs.core.windows.net/file
...
```
> bin/hadoop jar cloudstore-1.3.jar etag file
...
```
> bin/hadoop jar cloudstore-1.3.jar etag file2
