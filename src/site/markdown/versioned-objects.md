...
```bash
hadoop jar cloudstore-1.1.jar listversions -out out.tsv -limit 10  s3a://example-london/
```
...
hadoop jar cloudstore-1.1.jar listversions -q  s3a://example-london/
...
```bash
> hadoop jar cloudstore-1.1.jar restore s3a://example-london/FileSystemContractBaseTest "zn8c734o2CaH2ZfsS.I7_mpDl6kgh63O" /restored.txt
...
bin/hadoop jar cloudstore-1.1.jar listversions -deleted s3a://example-london/undelete.txt
...
```bash
hadoop jar cloudstore-1.1.jar undelete s3a://example-london/undelete.txt
...
```bash
> hadoop jar cloudstore-1.1.jar undelete -age 24000 -limit 10 s3a://example-london/
