...
```bash
> bin/hadoop jar cloudstore-1.2.jar fetchdt -p -r file:/tmp/secrets.bin s3a://landsat-pds/
...
```bash
> hadoop jar cloudstore-1.2.jar fetchdt -p -r file:/tmm/secrets.bin file:///
...
```bash
> hadoop jar cloudstore-1.2.jar fetchdt -p file:/tmm/secrets.bin file:///
Collecting tokens for 1 filesystem to to file:/tmp/secrets.bin
