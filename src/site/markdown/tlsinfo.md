...
```
> hadoop jar cloudstore-1.4.jar tlsinfo
...
```
> hadoop jar cloudstore-1.4.jar tlsinfo amazon
...
```
> hadoop jar cloudstore-1.4.jar tlsinfo -verbose amazon
...
```
hadoop jar cloudstore-1.4.jar tlsinfo unknown 
