...
```
> hadoop jar cloudstore-1.2.jar tlsinfo
...
```
> hadoop jar cloudstore-1.2.jar tlsinfo amazon
...
```
> hadoop jar cloudstore-1.2.jar tlsinfo -verbose amazon
...
```
hadoop jar cloudstore-1.2.jar tlsinfo unknown 
