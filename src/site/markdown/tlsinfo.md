...
```
> hadoop jar cloudstore-1.3.jar tlsinfo
...
```
> hadoop jar cloudstore-1.3.jar tlsinfo amazon
...
```
> hadoop jar cloudstore-1.3.jar tlsinfo -verbose amazon
...
```
hadoop jar cloudstore-1.3.jar tlsinfo unknown 
