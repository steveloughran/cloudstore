...
```
bin/hadoop jar cloudstore-1.4.jar bucketmetadata s3a://example-ap
...
```
hadoop jar cloudstore-1.4.jar bucketmetadata s3a://example--usw2-az1--x-s3
...
```
bin/hadoop jar cloudstore-1.4.jar bucketmetadata s3a://ecsbucket/
