...
public class EtagCommand extends StoreEntryPoint {
    ...
    public static final String USAGE = "Usage: etag\n" + STANDARD_OPTS + " <path>";
    ...
    public int run(String[] args) throws Exception {
        ...
        try (StoreDurationInfo duration = new StoreDurationInfo(LOG, "get path status for %s", source)) {
        ...
        if (st instanceof EtagSource) {
            ...
            throw new ExitUtil.ExitException(E_UNIMPLEMENTED, "Filesystem does not provide Etag information");
        }
        return 0;
    }
