...
/**
 * HDFS Diagnostics. DO NOT IMPORT ANY HDFS CLASSES.
 */
public class HDFSDiagnosticsInfo extends StoreDiagnosticsInfo {

  private static final Logger LOG = LoggerFactory.getLogger(HDFSDiagnosticsInfo.class);

  private static final Object[][] options = {{"fs.defaultFS", false, false},
      {"hadoop.security.authentication", false, false},
      {"hadoop.security.authorization", false, false}, {"hadoop.rpc.protection", false, false},
      {"dfs.client.cache.drop.behind.writes", false, false},
      {"dfs.client.cache.drop.behind.reads", false, false},
      {"dfs.client.cache.readahead", false, false}, {"dfs.client.context", false, false},
      ...
      {"dfs.client.local.interface", false, false}, {"dfs.client.mmap.enabled", false, false},
      ...
      {"dfs.client.socket-timeout", false, false}, {"dfs.client-write-packet-size", false, false},
      ...
      {"dfs.http.policy", false, false}, {"dfs.namenode.acls.enabled", false, false},
      {"dfs.namenode.rpc-address", false, false}, {"dfs.namenode.http-address", false, false},
      {"dfs.webhdfs.socket.connect-timeout", false, false},
      {"dfs.webhdfs.socket.read-timeout", false, false}, {"", false, false},};

  public static final String[] CLASSNAMES = {"org.apache.hadoop.hdfs.HdfsConfiguration",
      "org.apache.hadoop.ipc.RPC", "org.apache.hadoop.security.UserGroupInformation",
  ...
  /**
   * As protobuf is shaded on recent versions, different classnames may be required.
   */
  public static final String[] OPTIONAL_CLASSES = {"com.google.protobuf.ExtensionRegistry",
  ...
  /**
   * Patch by creating an HDFS Configuration instance; this will ensure hdfs-site.xml is picked up.
  ...
  public Configuration patchConfigurationToInitalization(final Configuration conf)
    ...
    try {
      ...
      Class<?> clazz = loader.loadClass("org.apache.hadoop.hdfs.HdfsConfiguration");
   ...
   */
  public static final String[] optionalCapabilities = {FS_ACLS, FS_APPEND, FS_CHECKSUMS, FS_CONCAT,
      FS_EXPERIMENTAL_BATCH_LISTING, FS_LIST_CORRUPT_FILE_BLOCKS, FS_PATHHANDLES, FS_PERMISSIONS,
      FS_SNAPSHOTS, FS_STORAGEPOLICY, FS_SYMLINKS, FS_TRUNCATE, FS_XATTRS};
  ...
  public List<EndpointProbe> listEndpointsToProbe(final Printout printout, final Configuration conf)
    ...
    if (isHttps) {
      addProbeFromOption(uris, conf, "dfs.namenode.https-address", "https://", "Namenode", "",
          true);
    } else {
