...
public class PathCapabilityChecker {
  ...
  /**
   * Does an object have a capability? uses reflection so the jar can compile/run against older
   * hadoop releases. throws ExitException(E_UNSUPPORTED_VERSION) if the api isn't found.
   * 
   * @param fs filesystem
   * @param path path
