...
public class AuditTool extends StoreEntryPoint {
    ...
    public static final String PURPOSE =
            "\n\nUSAGE:\nMerge and parse audit log files and convert into avro files " + "for better visualization";
    ...
    public static final String USAGE = "Usage: auditlogs\n"
            + STANDARD_OPTS
    ...
    public int run(final String[] args) throws ExitUtil.ExitException, Exception {
        ...
        println(
                "Processed %d records of which %d had audit information",
