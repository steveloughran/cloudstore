...
/**
 * AuditTool is a Command Line Interface. Its functionality is to parse the audit log files and
 * generate avro file.
 */
public class AuditTool extends StoreEntryPoint {
   ...
   */
  public static final String AUDIT_TOOL = "auditlogs";
  ...
  public static final String USAGE =
      "Usage: auditlogs\n" + STANDARD_OPTS + " <path of source files>" + " <path of output file>"
  ...
  /**
   * This run method in AuditTool takes source and destination path of bucket, and checks if there
   * are directories and pass these paths to merge and parse audit log files.
   * 
   ...
   */
  @Override
  public int run(final String[] args) throws ExitUtil.ExitException, Exception {
    ...
    auditProcessor.mergeAndParseAuditLogFiles(logsPath, destPath, hasOption(OVERWRITE),
    ...
    println("Processed %d records of which %d had audit information",
        auditProcessor.getLogRecordsProcessed(), auditProcessor.getReferrerHeadersParsed());
