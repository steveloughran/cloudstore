...
public class OptionSets {
    ...
    public static final String[] SYSPROPS_TO_SKIP = {
        CLASSPATH, "sun.java.command" // keeps command line secrets out the log
    };
    ...
    public static final class EnhancedOpenFileOptions {
         ...
         */
        public static final Set<String> FS_OPTION_OPENFILE_STANDARD_OPTIONS = Collections.unmodifiableSet(Stream.of(
         ...
         */
        public static final Set<String> FS_OPTION_OPENFILE_READ_POLICIES = Collections.unmodifiableSet(Stream.of(
