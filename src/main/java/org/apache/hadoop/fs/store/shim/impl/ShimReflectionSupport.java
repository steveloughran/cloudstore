...
public final class ShimReflectionSupport {
     ...
     * @return the method or null
     */
    public static <T> Invocation<T> getInvocation(Class<?> source, String name, Class<?>... parameterTypes) {
     ...
     */
    public static Optional<Method> loadMethodOptional(Class<?> source, String name, Class<?>... parameterTypes) {
     ...
     */
    public static Object invokeOperation(String operation, Object instance, Method method, Object... parameters)
            throws IOException {
        if (method == null) {
     ...
     */
    public static Object invokeUnchecked(String operation, Object instance, Method method, Object... parameters) {
        if (method == null) {
            throw new UnsupportedOperationException("No " + operation + " in " + instance);
        }
        try {
