...
/**
 * Base class for any API shim. Subclasses provide the class-specific operations; one of them must
 * then be created for every instance of the class to work with.
 * 
