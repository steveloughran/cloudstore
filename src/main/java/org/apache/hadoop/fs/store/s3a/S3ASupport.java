...
public class S3ASupport {
     ...
     */
    public static String lookupPassword(Configuration conf, String key, String defVal) throws IOException {
        try {
    ...
    /** @deprecated  */
    @Deprecated
    public static String lookupPassword(String bucket, Configuration conf, String baseKey, String overrideVal)
            throws IOException {
    ...
    public static String lookupPassword(
            String bucket, Configuration conf, String baseKey, String overrideVal, String defVal) throws IOException {
        String initialVal;
    ...
    private static String lookupPassword2(Configuration conf, String key, String defVal) throws IOException {
        try {
