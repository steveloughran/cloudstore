 ...
 */
public class Allocator extends DiagnosticsEntryPoint {

    private static final Logger LOG = LoggerFactory.getLogger(Allocator.class);

    public static final String USAGE = "Usage: constval class field";
    ...
    public static String lookupFieldValue(String classname, String field) throws StoreDiagException {
        ...
        try {
            ...
            throw new StoreDiagException(E_NOT_FOUND2, "Field not found: " + field + " in " + classname).initCause(e);

        } catch (SecurityException e) {
            throw new StoreDiagException(E_NO_ACCESS, "No access to " + field + " in " + classname).initCause(e);
        }
        ...
        try {
            ...
            throw new StoreDiagException(E_EXCEPTION_THROWN, "No access to " + field + " in " + classname + ": " + e)
                    .initCause(e);
        }
    }
     ...
     * @return const value
     */
    public static Optional<String> optionalValueOf(String classname, String field) {
        try {
    ...
    public static int exec(String... args) throws Exception {
        return ToolRunner.run(new Allocator(), args);
    }
