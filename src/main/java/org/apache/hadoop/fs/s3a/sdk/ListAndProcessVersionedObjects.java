...
public class ListAndProcessVersionedObjects {
  ...
  public ListAndProcessVersionedObjects(final String name, final Printout out,
      final S3AFileSystem fs, final Path source, final SummaryProcessor processor,
      final Instant ageLimit, final long limit) {
  ...
  public long execute() throws IOException {
    ...
    ListObjectVersionsRequest request =
        createListVersionsRequest(source.toUri().getHost(), key, null);
