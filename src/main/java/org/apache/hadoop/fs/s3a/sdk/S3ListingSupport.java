...
public class S3ListingSupport {
     ...
     * @return the request
     */
    public static ListObjectsV2Request createListObjectsV2Request(final String bucket, String key, String delimiter) {
    ...
    public static ListObjectsRequest createListObjectsV1Request(final String bucket, String key, String delimiter) {
    ...
    public static ListObjectVersionsRequest createListVersionsRequest(
            final String bucket, String key, String delimiter) {
    ...
    public static String stringify(S3Object summary) {
        return String.format(
                "\"%s\"\tsize: [%d]\t%s\ttag: %s",
                summary.key(), summary.size(), summary.lastModified().toString(), summary.eTag());
    }
