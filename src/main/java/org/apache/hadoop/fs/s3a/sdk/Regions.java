...
public class Regions extends StoreEntryPoint {
    ...
    public int run(String[] args) throws Exception {
        ...
        printRegion("SystemSettingsRegionProvider", new SystemSettingsRegionProvider(), "System property aws.region");
        printRegion("AwsProfileRegionProvider", new AwsProfileRegionProvider(), "Region info in ~/.aws/config");
        printRegion(
