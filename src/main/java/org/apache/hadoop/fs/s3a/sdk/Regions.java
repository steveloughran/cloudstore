...
public class Regions extends StoreEntryPoint {
  ...
  public static final String USAGE = "Usage: regions";
  ...
  public int run(String[] args) throws Exception {
    ...
    printRegion("SystemSettingsRegionProvider", new SystemSettingsRegionProvider(),
        "System property aws.region");
    printRegion("AwsProfileRegionProvider", new AwsProfileRegionProvider(),
        "Region info in ~/.aws/config");
    printRegion("InstanceMetadataRegionProvider", new InstanceProfileRegionProvider(),
  ...
  private boolean printRegion(String name, AwsRegionProvider provider, String comment) {
    heading("Determining region using %s", name);
    println("%s", comment);
    String region = null;
    try (StoreDurationInfo ignored = new StoreDurationInfo(LOG, "%s.getRegion()", name)) {
