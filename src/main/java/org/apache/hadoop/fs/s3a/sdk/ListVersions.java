...
public class ListVersions extends StoreEntryPoint {
    ...
    public int run(String[] args) throws Exception {
        ...
        try (StoreDurationInfo duration = new StoreDurationInfo(getOut(), name)) {
            ...
            println();
            println(
                    "Found %,d objects under %s with total size %,d bytes",
                    listing.getObjectCount(), source, listing.getTotalSize());

            println(
                    "Hidden file count %,d with hidden data size %,d bytes",
            ...
            println(
                    "Tombstone entries %,d comprising %,d files and %,d dir markers",
