...
public class BulkDeleteCommand extends StoreEntryPoint {
  ...
  public int run(String[] args) throws Exception {
    ...
    final List<Path> pathsToDelete = toDelete.stream().map(l -> fs.makeQualified(new Path(l)))
        .filter(p -> !p.isRoot()).collect(Collectors.toList());
    ...
    heading("Summary");
    println("Bulk delete of %d file(s) finished, duration: %s", files,
        executionDuration.getDurationString());
