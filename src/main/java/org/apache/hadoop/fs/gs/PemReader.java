...
/**
 * derivative of the google pem reader which requires a section title and provides diagnostics.
 */
public class PemReader implements Closeable {
  ...
  public Section readNextSection(String titleToLookFor) throws IOException {
    ...
    while (true) {
      ...
      lines++;
      if (line == null) {
        return new Section(titleToLookFor, lines, "no match for line '" + scan + "'");
      }
      if (scan.equals(line)) {
        break;
      }
    ...
    while (true) {
      ...
      if (scan.equals(line)) {
        return new Section(titleToLookFor, lines, Base64.decodeBase64(keyBuilder.toString()));
      }

      keyBuilder.append(line);
    }
    return new Section(titleToLookFor, lines - start, "no match for line <" + scan + ">");
  }
  ...
  public static final class Section {
    ...
    public String toString() {
      return "Section{" + "success=" + success + ", title='" + title + '\'' + ", lines=" + lines
          + ", message='" + message + '\'' + '}';
    }
