...
public final class CsvWriterWithCRC extends SimpleCsvWriter {
     ...
     */
    public CsvWriterWithCRC(final Writer out, final String separator, final String eol, final boolean quote) {
     ...
     * @param quote quote columns?
     */
    public CsvWriterWithCRC(final OutputStream out, final String separator, final String eol, final boolean quote) {
