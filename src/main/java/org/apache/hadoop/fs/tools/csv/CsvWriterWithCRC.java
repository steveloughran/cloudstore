...
/**
 * This is a small utility class to write out rows to a CSV/TSV file. It does not do any escaping of
 * written text, so don't write entries containing separators. Quoting must be done external to this
 * class.
 */
public final class CsvWriterWithCRC extends SimpleCsvWriter {
   ...
   */
  public CsvWriterWithCRC(final Writer out, final String separator, final String eol,
      final boolean quote) {
   ...
   * @param quote quote columns?
   */
  public CsvWriterWithCRC(final OutputStream out, final String separator, final String eol,
      final boolean quote) {
