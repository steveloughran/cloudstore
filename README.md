...
Example executed on hadoop 3.3.4 RC0 with s3a configured to dump
iostats in FileSystem.close(); MBP M1Pro connected to Gigabit FTTH connection by ethernet cable.
...
This is also why application code which assumes that closing a stream is fast are at risk
